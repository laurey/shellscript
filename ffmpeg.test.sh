...
while true
    do
        ...
        # ffmpeg -i They-Don\'t-Care-About-Us.mp4 -f mp4 -map 0:a -b:a 128k -ar 44100 -acodec mp3 copy -vn -t 250 test.mp3
        # ffmpeg -i They-Don\'t-Care-About-Us.mp4 -f mp4 -map 0:a -b:a 128k -bufsize 128k -ar 44100 -codec:a libmp3lame copy -vn test2.mp3
        ...
        command="ffmpeg -i $videopath -f mp4 -map 0:a -b:a 128k -bufsize 128k -id3v2_version 3 -ar 44100 -acodec libmp3lame copy -vn $outputfile"
        echo $command
        eval $command
       break
    done
